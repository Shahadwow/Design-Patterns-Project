...
public final class Calculator extends javax.swing.JFrame {
    ...
    public void addEvents() {
        ...
        btnPower.addActionListener(e -> calculator.pressPower());
        btnSqrt.addActionListener(e -> calculator.pressSqrt());
    ...
    private void initComponents() {
        ...
        previous.setFont(new java.awt.Font("Century Gothic", 1, 18));
        ...
        current.setFont(new java.awt.Font("Century Gothic", 1, 24));
        ...
        buttonsPanel.add(btnDel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 64, 70));
        ...
        buttonsPanel.add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(64, 0, 64, 70));
        ...
        buttonsPanel.add(btnDiv, new org.netbeans.lib.awtextra.AbsoluteConstraints(128, 0, 64, 70));
        ...
        buttonsPanel.add(btnMult, new org.netbeans.lib.awtextra.AbsoluteConstraints(192, 0, 64, 70));

        btnPower.setBackground(new java.awt.Color(41, 39, 44));
        btnPower.setFont(new java.awt.Font("Century Gothic", 1, 18));
        ...
        buttonsPanel.add(btnPower, new org.netbeans.lib.awtextra.AbsoluteConstraints(256, 0, 64, 70));
        ...
        buttonsPanel.add(btn7, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, 64, 70));
        ...
        buttonsPanel.add(btn8, new org.netbeans.lib.awtextra.AbsoluteConstraints(64, 70, 64, 70));
        ...
        buttonsPanel.add(btn9, new org.netbeans.lib.awtextra.AbsoluteConstraints(128, 70, 64, 70));
        ...
        buttonsPanel.add(btnSub, new org.netbeans.lib.awtextra.AbsoluteConstraints(192, 70, 64, 70));

        btnSqrt.setBackground(new java.awt.Color(41, 39, 44));
        btnSqrt.setFont(new java.awt.Font("Century Gothic", 1, 18));
        ...
        buttonsPanel.add(btnSqrt, new org.netbeans.lib.awtextra.AbsoluteConstraints(256, 70, 64, 70));
        ...
        buttonsPanel.add(btn4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 140, 64, 70));
        ...
        buttonsPanel.add(btn5, new org.netbeans.lib.awtextra.AbsoluteConstraints(64, 140, 64, 70));
        ...
        buttonsPanel.add(btn6, new org.netbeans.lib.awtextra.AbsoluteConstraints(128, 140, 64, 70));
        ...
        buttonsPanel.add(btnPlus, new org.netbeans.lib.awtextra.AbsoluteConstraints(192, 140, 128, 70));
        ...
        buttonsPanel.add(btn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 210, 64, 70));
        ...
        buttonsPanel.add(btn2, new org.netbeans.lib.awtextra.AbsoluteConstraints(64, 210, 64, 70));
        ...
        buttonsPanel.add(btn3, new org.netbeans.lib.awtextra.AbsoluteConstraints(128, 210, 64, 70));
        ...
        buttonsPanel.add(btnPlusSub, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 280, 64, 70));
        ...
        buttonsPanel.add(btn0, new org.netbeans.lib.awtextra.AbsoluteConstraints(64, 280, 64, 70));
        ...
        buttonsPanel.add(btnDot, new org.netbeans.lib.awtextra.AbsoluteConstraints(128, 280, 64, 70));
        ...
        buttonsPanel.add(btnEqual, new org.netbeans.lib.awtextra.AbsoluteConstraints(192, 210, 128, 140));
